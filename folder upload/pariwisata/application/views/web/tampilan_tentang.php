...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item control active"><a href="<?php echo base_url(); ?>Tentang" class="nav-link icon-info">&nbspTentang</a></li>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('<?php echo base_url();?>asset/images/tangan.jpg');">
