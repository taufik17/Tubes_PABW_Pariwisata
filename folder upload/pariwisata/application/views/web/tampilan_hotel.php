...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item control active"><a href="<?php echo base_url(); ?>Hotel" class="nav-link icon-hotel">&nbspHotel</a></li>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('<?php echo base_url();?>asset/images/bg-hotel.jpg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div style="background-color: rgba(99, 68, 64, 0.59)" class="col-md-9 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><strong>&nbsp&nbspHotel terbaik untuk Anda <br></strong>
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
        <h2 class="mb-4"><strong>Hotel</strong></h2>
        <div class="row">
        	<div class="col-lg-3 sidebar">
        		<div class="sidebar-wrap bg-light ftco-animate">
        			<h3 class="heading mb-4">Temukan Hotel</h3>
        			<form action="#">
        				<div class="fields">
		    			...
		    			<div class="col-md-4 ftco-animate">
		    				<div class="destination">
		    					...
		    					<div class="text p-3">
		    						<div class="d-flex">
		    							<div class="one">
				    						<h3><a href="<?php echo base_url();?>hotel/pos/<?php echo $nhotel->id_hotel; ?>"><?php echo $nhotel->nama_hotel; ?></a></h3>
				    						<p class="rate">
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
				    							<i class="icon-star"></i>
			    						...
			    						<div class="two">
			    							<span class="price per-price"><?php echo $nhotel->harga; ?></span>
		    							</div>
		    						</div>
		    						<p><?php echo $nhotel->lokasi; ?></p>
		    						<hr>
