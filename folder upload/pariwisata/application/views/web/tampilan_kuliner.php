...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item control active"><a href="<?php echo base_url(); ?>Kuliner" class="nav-link icon-cutlery">&nbspKuliner</a></li>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('<?php echo base_url();?>asset/images/bg-kuliner.jpg');">
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div style="background-color: rgba(39, 66, 66, 0.59)" class="col-md-9 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><strong>&nbsp&nbspKuliner terbaik untuk Anda <br></strong>
    ...
    <section class="ftco-section ftco-degree-bg">
      <div class="container">
        <h2 class="mb-4"><strong>Kuliner</strong></h2>
        <div class="row">
        	<div class="col-lg-3 sidebar">
        		<div class="sidebar-wrap bg-light ftco-animate">
        			<h3 class="heading mb-4">Temukan Kuliner</h3>
        			<form action="#">
        				<div class="fields">
