<script type="text/javascript">
	function cekform()
	{
		if (!$("#id_hotel").val())
		{
			alert('maaf id_hotel tidak boleh kosong');
		...
		if (!$("#nama_hotel").val())
		{
			alert('maaf nama hotel tidak boleh kosong');
			$("#nama_hotel_Leader").focus();
			return false;
		}
...
<div>&nbsp </div>
<div>&nbsp </div>
<form class="form-horizontal" method="POST" action="<?php echo base_url();?>Hotel_admin/simpan" onsubmit="return cekform();" enctype="multipart/form-data">
