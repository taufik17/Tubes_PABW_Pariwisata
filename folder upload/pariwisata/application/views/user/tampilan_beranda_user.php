...
<html lang="en">
	...
	<body>
		<div class="navbar">
			<div class="navbar-inner"style="background: #0b2e13">
				<div class="container-fluid">
					<a href="<?php echo base_url();?>Berandauser" class="brand">
						<small>
							Halaman User
						</small>
					</a><!--/.brand-->

					<ul class="nav ace-nav pull-right" style="background: #0b2e13">
						<li class="light-blue"style="background: #0b2e13">
							...
							<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
								...
								<li>
									<a href="<?php echo base_url();?>Berandauser/logout">
										<i class="icon-off"></i>
										Logout
									</a>
								</li>
		...
		<div class="main-container container-fluid">
			...
			<div class="sidebar" id="sidebar">
				...
				<?php
                $this->load->view('user/tampilan_menu_user'); ?>
